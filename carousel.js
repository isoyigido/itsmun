...
const imageList = [
    ...
    '<img src="res/team/aca.jpg"><div class="overlay"></div><p>Academy Team<br><em>?</em></p>',
    ...
    '<img src="res/team/media.jpg"><div class="overlay"></div><p>Media Team<br><em>Onur Vatan Koruyucu - ? - Kemal Ege Metinoğlu (Head of Media)</em></p>',
    '<img src="res/team/ent.jpg"><div class="overlay"></div><p>Entertainment Team<br><em>? - Ahmet Mert Tünay (Head of Entertainment) - ? - ?</em></p>',
    '<img src="res/team/fat.jpg"><div class="overlay"></div><p>Finance Team<br><em>Mert Kağan Aydın - ? - Duru Gözmen (Deputy Head of Finance)</em></p>',
    '<img src="res/team/security.jpg"><div class="overlay"></div><p>Security<br><em>Eylül Derin Gürkan - ?</em></p>',
];
